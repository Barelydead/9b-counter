...
@section('main')
  ...
  <div class="container">
    <main class="d-flex">
      <a class="blurb__link" href="{{ route('sport-9b') }}">
      ...
      <a class="blurb__link" href="{{ route('sport-9a') }}">
      ...
      <a class="blurb__link" href="{{ route('boulder') }}">
      ...
      <a class="blurb__link" href="{{ route('trad') }}">
